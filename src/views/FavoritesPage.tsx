  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="p-3 rounded-xl bg-yellow-500/15 text-yellow-400"><Star size={22} /></div>
        <div>
          <h1 className="text-xl font-bold text-slate-100">Favorites</h1>
          <p className="text-sm text-slate-400">Your saved calculators for quick access</p>
        </div>
      </div>
      ...
      {favoriteCalculators.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-slate-500 text-sm mt-1">Click the ★ icon on any calculator card to add it here.</p>
        </div>
      ) : (
